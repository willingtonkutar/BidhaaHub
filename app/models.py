...
class Payment(Base):
    ...
    checkout_request_id: Mapped[str | None] = mapped_column(String(120), nullable=True)
    merchant_request_id: Mapped[str | None] = mapped_column(String(120), nullable=True)
    mpesa_receipt_number: Mapped[str | None] = mapped_column(String(120), nullable=True)
    mpesa_phone_number: Mapped[str | None] = mapped_column(String(50), nullable=True)
    mpesa_result_description: Mapped[str | None] = mapped_column(String(255), nullable=True)
